...
Für die Entwicklung des Projektes wurde der IDE Visual Studio Code (VSCode) 
ausgewählt. VSCode besitzt ein kostenloses Pluging, das das Pair Programming
erlaubt, das LiveShare heißt. Im Kombination mit Skype könnten wir das Projekt
gleichzeitig entwicklen.

Für den Code wurde ein Github Repository erstellt, der uns erlaubt hat,
