...
Pfad mit der Farbe des Spielers hinterlässt. Der Spieler kann sich nur nach
rechts oder links drehen und damit die Richtung seiner Bewegung ändern. Wenn
der Spieler nicht reagiert, bewegt er sich weiter in die alte Richtung.
...
Die Entscheidung, das Spiel in C++ statt C zu programmieren, lag 
