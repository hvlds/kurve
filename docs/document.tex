...
In dem Spiel wird User und Player differenziert. Das Spiel besitzt nur ein User,
der die kontrolle über den Computer besitzt und die Player, die mehrere sein
können.
